...
export const SEGMENTOS: Segmento[] = [
    { slug: "barbearias", descricao: "Controle o fiado da barbearia sem caderno: saldo de cada cliente, pacotes de corte e barba e cobrança pelo WhatsApp. Teste grátis por 14 dias.", plural: "barbearias", quem: "dono de barbearia",
    ...
    { slug: "personal-trainer", descricao: "Mensalidades e pacotes de aulas organizados: veja quem atrasou, quantas aulas sobraram e cobre o aluno pelo WhatsApp. Teste grátis por 14 dias.", plural: "personal trainers", quem: "personal trainer",
    ...
    { slug: "escola-de-musica", descricao: "Mensalidades, matrículas parceladas e vendas de material sob controle na sua escola de música. Cobrança pelo WhatsApp. Teste grátis por 14 dias.", plural: "escolas de música", quem: "dono de escola de música",
    ...
    { slug: "banho-e-tosa", descricao: "Fiado de banho, tosa e ração e pacotes por tutor, sem caderno: saldo de cada cliente e cobrança pelo WhatsApp. Teste grátis por 14 dias.", plural: "pet shops e banho e tosa", quem: "dono de pet shop",
    ...
    { slug: "funilaria-e-pintura", descricao: "Saldos de serviços de alto valor e pagamentos parcelados da funilaria organizados por cliente, com cobrança pelo WhatsApp. Teste grátis por 14 dias.", plural: "funilarias e oficinas", quem: "dono de funilaria",
    ...
    { slug: "floriculturas", descricao: "Encomendas para eventos, sinal e saldo e clientes de empresa que pagam depois: tudo no controle, com cobrança pelo WhatsApp. Teste grátis por 14 dias.", plural: "floriculturas", quem: "dono de floricultura",
    ...
    { slug: "fisioterapeutas", descricao: "Pacotes de sessões parcelados e pacientes com saldo em aberto sob controle, com lembrete de cobrança pelo WhatsApp. Teste grátis por 14 dias.", plural: "fisioterapeutas e clínicas", quem: "fisioterapeuta",
    ...
    { slug: "chaveiros", descricao: "Serviços para condomínios, imobiliárias e empresas que pagam em 15 ou 30 dias, com saldo por cliente e cobrança no prazo. Teste grátis por 14 dias.", plural: "chaveiros", quem: "chaveiro",
    ...
    { slug: "nutricionistas", descricao: "Pacotes de consultas e retornos pagos em parcelas, com saldo por paciente e cobrança pelo WhatsApp. Teste grátis por 14 dias.", plural: "nutricionistas", quem: "nutricionista",
    ...
    { slug: "artes-marciais", descricao: "Mensalidade de dezenas de alunos, graduação e uniforme parcelados: veja quem atrasou e cobre pelo WhatsApp. Teste grátis por 14 dias.", plural: "academias de artes marciais", quem: "dono de academia de artes marciais",
    ...
    { slug: "oficinas-mecanicas", descricao: "Serviços e peças a prazo, com saldo por cliente e cobrança no vencimento: controle o fiado da sua oficina mecânica. Teste grátis por 14 dias.", plural: "oficinas mecânicas", quem: "dono de oficina",
    ...
    { slug: "psicologos-e-terapeutas", descricao: "Pacotes de sessões, pacientes com saldo em aberto e retornos combinados sob controle, com lembrete discreto pelo WhatsApp. Teste grátis por 14 dias.", plural: "psicólogos e terapeutas", quem: "profissional de saúde",
    ...
    { slug: "estudios-e-academias", descricao: "Mensalidades de yoga, pilates, dança e natação organizadas: veja quem atrasou e cobre pelo WhatsApp sem constrangimento. Teste grátis por 14 dias.", plural: "estúdios e academias", quem: "dono de estúdio",
    ...
    { slug: "escolas-e-cursos", descricao: "Mensalidades, matrículas e material de cursos e escolas livres controlados por aluno, com cobrança pelo WhatsApp. Teste grátis por 14 dias.", plural: "escolas e cursos", quem: "dono de escola ou curso",
    ...
    { slug: "lojas", descricao: "Fiado de loja sem caderno: saldo de cada cliente, vencimentos e cobrança pelo WhatsApp para roupas, ótica, móveis e materiais. Teste grátis por 14 dias.", plural: "lojas", quem: "lojista",
    ...
    { slug: "coach", descricao: "Mentorias e programas pagos em parcelas: veja quem está em dia, quem atrasou e cobre pelo WhatsApp sem perder o clima. Teste grátis por 14 dias.", plural: "coaches e consultores", quem: "coach",
    ...
    { slug: "beleza-e-estetica", descricao: "Pacotes de sessões, procedimentos com sinal e saldo e clientes fixas sob controle no seu estúdio de beleza, com cobrança pelo WhatsApp. Teste grátis por 14 dias.", plural: "estúdios de beleza e estética", quem: "profissional de beleza",
    ...
    { slug: "servicos-sob-encomenda", descricao: "Orçamento aprovado com sinal e saldo na entrega: controle o que cada cliente já pagou e o que falta receber. Teste grátis por 14 dias, sem cartão.", plural: "marcenarias, vidraçarias e serviços sob encomenda", quem: "dono de negócio sob encomenda",
